...
<body>
    <div class=" w-full p-4 space-y-2">
        ...
        <div class="flex p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <form class="flex flex-col w-full" method="POST" action="{{ route('completeDataProfile') }}"
                ...
                <div class="flex justify-center items-center mb-6">
                    <div class="w-full max-w-md">
                        <img src="https://freesvg.org/img/abstract-user-flat-4.png" class="avatar img-thumbnail"
                            alt="avatar"
                            style="border-radius: 50%; width: 100px; height: 100px; border: 2px solid #999; margin-left: 175px;">
                        <input
                ...
                <div class="flex justify-center items-center mb-6">
                    <div class="w-full max-w-md">
                        <label for="nim" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            NIM:</label>
                        <input type="text" id="nim" pattern="[0-9]+ value="
                            ...
                            placeholder="Masukkan NIM" required readonly value="{{ $mahasiswa->nim }}">
                    </div>
                </div>
                ...
                <div class="flex justify-center items-center mb-6">
                    <div class="w-full max-w-md">
                        ...
                        <input type="text" id="nama"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-800 focus:border-blue-800 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Masukkan Nama" required readonly value="{{ $mahasiswa->nama }}">
                    </div>
                </div>
                ...
                <div class="flex justify-center items-center mb-6">
                    <div class="w-full max-w-md">
                        ...
                        <input type="number" id="angkatan" name="angkatan"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-800 focus:border-blue-800 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Masukkan Angkatan" min="2000" max="2030" required readonly
                ...
                <div class="flex justify-center items-center mb-6">
                    <div class="w-full max-w-md">
                        ...
                        <input type="text" id="status"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-800 focus:border-blue-800 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Masukkan Status" required readonly value="{{ $mahasiswa->status }}">
                    </div>
                </div>
                ...
                <div class="flex justify-center items-center mb-6">
                    <div class="w-full max-w-md">
                        <label for="no_telp" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            No Telepon:</label>
                        <input type="text" id="no_telp" name="no_telp" pattern="[0-9]+"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-800 focus:border-blue-800 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
