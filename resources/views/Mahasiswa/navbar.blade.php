                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="/irs"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">IRS</span>
                        </a>
                    </li>
                    <li>
                        <a href="/khs"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">KHS</span>
                        </a>
                    </li>
                    <li>
                        <a href="/pkl"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">PKL</span>
                        </a>
                    </li>
                    <li>
                    <li>
                        <a href="/skripsi" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group active">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 18 18">
                                <path
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Skripsi</span>
                        </a>
                    </li>
                </ul>
            </div>
