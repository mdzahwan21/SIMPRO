...
<div class="w-full">
    <div class="flex flex-col gap-8 p-4">
        <form class="flex flex-col w-full p-4 border-2 border-black border-dashed rounded-lg" id="mahasiswaForm" action="{{ route('inputmahasiswa.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-center items-center mb-6">
                <div class="w-full max-w-md">
                    ...
                    <input type="file" id="foto" name="foto" accept=".jpg" class="p-2">
                </div>
            </div>
