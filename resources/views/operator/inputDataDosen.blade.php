        ...
        <form class="flex flex-col w-full p-4 border-2 border-black border-dashed rounded-lg" id="dosenform" action="{{ route('inputdosen.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-center items-center mb-6">
                <div class="w-full max-w-md">
                    ...
                    <input type="file" id="foto" name="foto" accept=".jpg" class="bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-800 focus:border-blue-800 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
            </div>
