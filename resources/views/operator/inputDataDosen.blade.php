...
@section('content')
    <div class="w-full">
        <div class="flex flex-col gap-8 p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <form class="flex flex-col w-full p-4 border-2 border-black border-dashed rounded-lg mt-5" id="dosenform" action="{{ route('inputdosen') }}" enctype="multipart/form-data">
